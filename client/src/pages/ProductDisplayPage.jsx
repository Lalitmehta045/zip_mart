...
const ProductDisplayPage = () => {
  ...
  return (
    <section className='container mx-auto p-4 grid lg:grid-cols-2 '>
      <div className=''>
        <div className='bg-white lg:min-h-[65vh] lg:max-h-[65vh] rounded min-h-[200px] md:min-h-[300px] h-fit max-h-[500px] w-full flex justify-center items-center overflow-hidden'>
          <img
            src={data.image[image]}
            className='w-full h-full object-contain'
          />
        </div>
        <div className='flex items-center justify-center gap-3 my-2 overflow-x-auto scrollbar-none'>
          {
      ...
      <div className='p-4 lg:pl-7 text-base lg:text-lg'>
        ...
        <h2 className='font-semibold'>Why shop from ZipMart? </h2>
        <div>
      ...
      </div>
      {
        (data.category && data.category[0]) && (
          <div className='w-full overflow-hidden'>
            <CategoryWiseProductDisplay id={data?.category[0]?._id} name={"Similar Product"} />
          </div>
        )
      }
    </section>
